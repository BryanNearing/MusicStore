...
%>
		...
		<nav class='nav nav-tabs navbar-dark bg-dark' style="background-color: grey">
            ...
            <%
            if(cart != null){
            	out.print("<a href='/cart' class='nav-iten nav-link active' style='float: right'>Cart</a>");
            }
...
if(cart == null || cart.getCart().size() == 0){
	...
	List<Product> currentCart = cart.getCart();
...
<tr>
				...
				<td><a href='/removeFromCart?id=<%out.print(p.getId());%>'  name='id'>Remove</a></td>
			</tr>
</table>

<form:form action='/createOrder' method='get'>
